    ...
    render() {
        return(
            <div className="privacy">
                ...
                <ul>
                    ...
                    <li>
                        <p><strong>Application</strong> means the software program provided by the Company downloaded by
                            You on any electronic device, named CryptoPoP</p>
                    </li>
                    <li>
                        <p><strong>Company</strong> (referred to as either &quot;the
                            Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers
                            to JaNatCommunications LLC, 2609 Dubai World Trade Center, Freezone, Dubai, UAE.</p>
                    ...
                    <li>
                        <p><strong>Facebook Fan Page</strong> is a public profile named CryptoPoP FB Page specifically
                            created by the Company on the Facebook social network, accessible from <a
                                href="https://facebook.com/CryptoPoP" rel="external nofollow noopener"
                                target="_blank">https://facebook.com/CryptoPoP</a></p>
                    </li>
                    <li>
                    ...
                    <li>
                        <p><strong>Website</strong> refers to Cryptopop, accessible from <a href="www.cryptopop.fun"
                                                                                            rel="external nofollow noopener"
                                                                                            target="_blank">www.cryptopop.fun</a>
                        </p>
                    </li>
                    <li>
                        ...
                        <p>Under GDPR (General Data Protection Regulation), You can be referred to as the Data Subject
                            or as the User as you are the individual using the Service.</p>
                    </li>
                </ul>
                ...
                <p>When You pay for a product and/or a service via bank transfer, We may ask You to provide information
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <p>Type: Persistent Cookies</p>
                        <p>Administered by: Third-Parties</p>
                        <p>Purpose: These Cookies track your browsing habits to enable Us to show advertising which is
                ...
                <ul>
                    <li>
                        ...
                        <p>You may opt-out of certain Google Analytics features through your mobile device settings,
                            such as your device advertising settings or by following the instructions provided by Google
                            in their Privacy Policy: <a href="https://policies.google.com/privacy"
                                                        rel="external nofollow noopener"
                ...
                <h2>Advertising</h2>
                <p>We may use Service Providers to show advertisements to You to help support and maintain Our
                    Service.</p>
                <ul>
                    <li>
                        ...
                        <p>You may opt out of the use of the DoubleClick Cookie for interest-based advertising by
                            visiting the Google Ads Settings web page: <a href="http://www.google.com/ads/preferences/"
                                                                          rel="external nofollow noopener"
                    ...
                    <li>
                        ...
                        <p>You can opt-out from InMobi service by following the instructions as described on the InMobi
                            Opt-out page: <a href="http://www.inmobi.com/page/opt-out/" rel="external nofollow noopener"
                                             target="_blank">http://www.inmobi.com/page/opt-out/</a></p>
                        <p>For more information on the privacy practices and policies of InMobi, please visit the InMobi
                            Privacy Policy: <a href="http://www.inmobi.com/privacy-policy/"
                                               rel="external nofollow noopener"
                                               target="_blank">http://www.inmobi.com/privacy-policy/</a></p>
                    </li>
                    <li>
                        <p><strong>StartApp</strong></p>
                        <p>StartApp is provided by StartApp Inc.</p>
                        <p>You can opt-out from interest-based ads served by StartApp by following the instructions on
                            their Privacy Policy, section &quot;8. Your Choices and Controls&quot;: <a
                                href="https://www.startapp.com/policy/privacy-policy/" rel="external nofollow noopener"
                                target="_blank">https://www.startapp.com/policy/privacy-policy/</a></p>
                        <p>For more information on what information StartApp collects and how it is used, please read
                            their Privacy Policy: <a href="https://www.startapp.com/policy/privacy-policy/"
                                                     rel="external nofollow noopener"
                                                     target="_blank">https://www.startapp.com/policy/privacy-policy/</a>
                        </p>
                    </li>
                </ul>
                <h2>Payments</h2>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <p>Their Privacy Policy can be viewed at <a
                            href="https://www.paypal.com/webapps/mpp/ua/privacy-full" rel="external nofollow noopener"
                            target="_blank">https://www.paypal.com/webapps/mpp/ua/privacy-full</a></p>
                    </li>
                    <li>
                        <p><strong>Binance Wallet</strong></p>
                        <p>Their Privacy Policy can be viewed at <a href="https://www.binance.com/en/privacy"
                                                                    rel="external nofollow noopener"
                                                                    target="_blank">https://www.binance.com/en/privacy</a>
                        </p>
                    </li>
                </ul>
                ...
                <p>The Company is the Data Controller of Your Personal Data collected while using the Service. As
                    operator of the Facebook Fan Page <a href="https://facebook.com/CryptoPoP"
                                                         rel="external nofollow noopener"
                                                         target="_blank">https://facebook.com/CryptoPoP</a>, the Company
                    and the operator of the social network Facebook are Joint Controllers.</p>
                ...
                <p>Visit the Facebook Privacy Policy <a href="https://www.facebook.com/policy.php"
                                                        rel="external nofollow noopener"
                                                        target="_blank">https://www.facebook.com/policy.php</a> for more
                ...
                <p>For more information on the privacy practices of Facebook, please visit Facebook Privacy Policy
                    here: <a href="https://www.facebook.com/privacy/explanation" rel="external nofollow noopener"
                ...
                <ul>
                    <li>By email: janat.communications@gmail.com
                    </li>
                </ul>
            </div>
        )
