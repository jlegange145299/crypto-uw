                ...
                <ul>
                    ...
                    <li>
                        <p><strong>Company</strong> (referred to as either &quot;the
                            ...
                            to JanatCommunications, Shoreline Building 2.</p>
                    </li>
                    <li>
                    ...
                    <li>
                        <p><strong>Website</strong> refers to CryptoPoP, accessible from <a
                            href="http://www.cryptopop.fun" rel="external nofollow noopener"
                            target="_blank">http://www.cryptopop.fun</a></p>
                    </li>
                    <li>
                ...
                <ul>
                    <li>
                        <p>By email: <a href="/cdn-cgi/l/email-protection" className="__cf_email__"
                                        data-cfemail="86ece7e8e7f2e5e9ebebf3e8efe5e7f2efe9e8f5c6e1ebe7efeaa8e5e9eb">[email&#160;protected]</a>
                        </p>
                    </li>
                    <li>
                        <p>By visiting this page on our website: <a href="http://www.cryptopop.fun/contact"
                                                                    rel="external nofollow noopener"
                                                                    target="_blank">http://www.cryptopop.fun/contact</a>
                        </p>
                    </li>
                </ul>
            </div>
